...
function Footer() {
  // Returned JSX
  return (
    <footer className="relative border-t border-main-color mt-20 ml-6 md:ml-0 mr-6 md:mr-12 pt-12 pb-8 text-stone-400/75 text-[1.4rem] xs:text-[1.5rem] flex flex-col sm:grid grid-cols-9 gap-x-12 2xl:gap-x-4 gap-y-16 overflow-hidden">
