...
function Button({
  ...
  return (
    <button
      className={`inline-block font-bold rounded-lg cursor-pointer text-white hover:bg-none hover:bg-stone-50 hover:text-red-900 disabled:cursor-not-allowed uppercase text-[1.3rem] md:text-[1.6rem] ${
